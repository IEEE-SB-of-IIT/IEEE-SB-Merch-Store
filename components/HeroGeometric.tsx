...
/* Without WebGL, three.js throws while creating its context; uncaught, that
   unmounts the whole React tree. Contain it so the hero just falls back to
   its plain background and the rest of the store keeps working. */
                        ...
                        <div className="flex flex-col items-center text-center gap-2 md:gap-4 mb-8 md:mb-12">
                            {title1 && (
                                <div className="overflow-hidden">
                                    ...
                                    >
                                        <span className="font-garamond italic font-light text-[#1a1a1a]">
                                            {title1}
                                        </span>
                                    </motion.h1>
                                </div>
                            ...
                            {logoImage ? (
                                ...
                                >
                                    <Image
                                        ...
                                        width={3942}
                                        height={389}
                                        className="w-[52vw] max-w-[560px] h-auto"
                                        priority
                                    />
                                </motion.div>
                            ) : title2 ? (
                                <div className="overflow-hidden">
                                    <motion.h1
                                        ...
                                        animate={{ y: "0%", opacity: 1 }}
                                        transition={{ duration: 1, ease: [0.16, 1, 0.3, 1], delay: 0.35 }}
                                        className="text-[12cqi] md:text-[8cqi] lg:text-[6cqi] leading-[0.9] tracking-tighter font-manrope font-extrabold text-black"
                                    >
                                        {title2}
                                    </motion.h1>
                                </div>
                        ...
                        {description && (
                            <div className="max-w-[480px] text-center mb-8">
                                <motion.p
                                    ...
                                    className="text-lg md:text-[1.35rem] leading-relaxed text-neutral-600 font-manrope font-normal"
                                >
                                    {description}
                                </motion.p>
                            </div>
