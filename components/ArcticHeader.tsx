...
export default function ArcticHeader() {
    return (
        <nav className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-8 py-6 text-white text-[10px] tracking-[0.2em] font-medium mix-blend-difference">
            {/* Left Brand */}
            <div className="text-xl font-bold tracking-tighter">TR/RN</div>
