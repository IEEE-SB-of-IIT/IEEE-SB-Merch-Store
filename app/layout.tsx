...
import { Outfit, Space_Grotesk, Bebas_Neue, Courier_Prime, Space_Mono } from "next/font/google";
...
export default function RootLayout({ children }: { children: ReactNode }) {
    return (
        <html lang="en" className="scroll-smooth">
            <body className={`${outfit.variable} ${spaceGrotesk.variable} ${aerosoldier.variable} ${bebasNeue.variable} ${courierPrime.variable} ${spaceMono.variable} font-sans antialiased`}>
                <ThemeProvider>
                    <CartProvider>
                        {children}
                    </CartProvider>
